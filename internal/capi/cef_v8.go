...
func RegisterV8(handle uintptr) {
	purego.RegisterLibFunc(&CEFV8ContextGetCurrentContext, handle, "cef_v8_context_get_current_context")
	purego.RegisterLibFunc(&CEFV8ContextGetEnteredContext, handle, "cef_v8_context_get_entered_context")
	purego.RegisterLibFunc(&CEFV8ContextInContext, handle, "cef_v8_context_in_context")
	purego.RegisterLibFunc(&CEFV8ValueCreateUndefined, handle, "cef_v8_value_create_undefined")
	purego.RegisterLibFunc(&CEFV8ValueCreateNull, handle, "cef_v8_value_create_null")
	purego.RegisterLibFunc(&CEFV8ValueCreateBool, handle, "cef_v8_value_create_bool")
	purego.RegisterLibFunc(&CEFV8ValueCreateInt, handle, "cef_v8_value_create_int")
	purego.RegisterLibFunc(&CEFV8ValueCreateUint, handle, "cef_v8_value_create_uint")
	purego.RegisterLibFunc(&CEFV8ValueCreateDouble, handle, "cef_v8_value_create_double")
	purego.RegisterLibFunc(&CEFV8ValueCreateDate, handle, "cef_v8_value_create_date")
	purego.RegisterLibFunc(&CEFV8ValueCreateString, handle, "cef_v8_value_create_string")
	purego.RegisterLibFunc(&CEFV8ValueCreateObject, handle, "cef_v8_value_create_object")
	purego.RegisterLibFunc(&CEFV8ValueCreateArray, handle, "cef_v8_value_create_array")
	purego.RegisterLibFunc(&CEFV8ValueCreateArrayBuffer, handle, "cef_v8_value_create_array_buffer")
	purego.RegisterLibFunc(&CEFV8ValueCreateArrayBufferWithCopy, handle, "cef_v8_value_create_array_buffer_with_copy")
	purego.RegisterLibFunc(&CEFV8ValueCreateFunction, handle, "cef_v8_value_create_function")
	purego.RegisterLibFunc(&CEFV8ValueCreatePromise, handle, "cef_v8_value_create_promise")
	purego.RegisterLibFunc(&CEFV8StackTraceGetCurrent, handle, "cef_v8_stack_trace_get_current")
	purego.RegisterLibFunc(&CEFRegisterExtension, handle, "cef_register_extension")
}
