...
func AddCrossOriginWhitelistEntry(sourceOrigin string, targetProtocol string, targetDomain string, allowTargetSubdomains int32) int32 {
	sourceOriginStr := cefString(sourceOrigin)
	defer freeCefString(&sourceOriginStr)
	targetProtocolStr := cefString(targetProtocol)
	defer freeCefString(&targetProtocolStr)
	targetDomainStr := cefString(targetDomain)
	defer freeCefString(&targetDomainStr)
	return int32(raw.CEFAddCrossOriginWhitelistEntry(unsafe.Pointer(&sourceOriginStr), unsafe.Pointer(&targetProtocolStr), unsafe.Pointer(&targetDomainStr), allowTargetSubdomains))
}
...
func RemoveCrossOriginWhitelistEntry(sourceOrigin string, targetProtocol string, targetDomain string, allowTargetSubdomains int32) int32 {
	sourceOriginStr := cefString(sourceOrigin)
	defer freeCefString(&sourceOriginStr)
	targetProtocolStr := cefString(targetProtocol)
	defer freeCefString(&targetProtocolStr)
	targetDomainStr := cefString(targetDomain)
	defer freeCefString(&targetDomainStr)
	return int32(raw.CEFRemoveCrossOriginWhitelistEntry(unsafe.Pointer(&sourceOriginStr), unsafe.Pointer(&targetProtocolStr), unsafe.Pointer(&targetDomainStr), allowTargetSubdomains))
}
...
func ClearCrossOriginWhitelist() int32 {
	return int32(raw.CEFClearCrossOriginWhitelist())
}
