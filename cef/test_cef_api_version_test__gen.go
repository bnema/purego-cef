...
func (obj *apiVersionTestImpl) SetRefPtrClient(val ApiVersionTestRefPtrClient) int32 {
	...
	valPtr := extractOrWrapRawPointer(val, func() any { return NewApiVersionTestRefPtrClient(val) })
	transferRef(valPtr)
...
func (obj *apiVersionTestImpl) GetRefPtrClientListByRef(valcount *int, val []ApiVersionTestRefPtrClient, val1 ApiVersionTestRefPtrClient, val2 ApiVersionTestRefPtrClient) int32 {
	...
	val1Ptr := extractOrWrapRawPointer(val1, func() any { return NewApiVersionTestRefPtrClient(val1) })
	transferRef(val1Ptr)
	val2Ptr := extractOrWrapRawPointer(val2, func() any { return NewApiVersionTestRefPtrClient(val2) })
	transferRef(val2Ptr)
...
func (obj *apiVersionTestImpl) SetChildRefPtrClientV2(val ApiVersionTestRefPtrClientChildV2) int32 {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetChildRefPtrClientV2 == 0 {
		return 0
	}
	valPtr := extractOrWrapRawPointer(val, func() any { return NewApiVersionTestRefPtrClientChildV2(val) })
	transferRef(valPtr)
	ret := rawPtr.CallSetChildRefPtrClientV2(valPtr)
	runtime.KeepAlive(val)
	return int32(ret)
}
...
func (obj *apiVersionTestImpl) SetChildRefPtrClientAndReturnParentV2(val ApiVersionTestRefPtrClientChildV2) ApiVersionTestRefPtrClient {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetChildRefPtrClientAndReturnParentV2 == 0 {
		return nil
	}
	valPtr := extractOrWrapRawPointer(val, func() any { return NewApiVersionTestRefPtrClientChildV2(val) })
	transferRef(valPtr)
	ret := rawPtr.CallSetChildRefPtrClientAndReturnParentV2(valPtr)
	runtime.KeepAlive(val)
	return wrapApiVersionTestRefPtrClient(unsafe.Pointer(ret))
}
...
func (obj *apiVersionTestImpl) SetChildOwnPtrClientV2(val ApiVersionTestScopedClientChildV2) int32 {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetChildOwnPtrClientV2 == 0 {
		return 0
	}
	valPtr := extractOrWrapRawPointer(val, func() any { return NewApiVersionTestScopedClientChildV2(val) })
	transferRef(valPtr)
	ret := rawPtr.CallSetChildOwnPtrClientV2(valPtr)
	runtime.KeepAlive(val)
	return int32(ret)
}
...
func (obj *apiVersionTestImpl) SetChildOwnPtrClientAndReturnParentV2(val ApiVersionTestScopedClientChildV2) ApiVersionTestScopedClient {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetChildOwnPtrClientAndReturnParentV2 == 0 {
		return nil
	}
	valPtr := extractOrWrapRawPointer(val, func() any { return NewApiVersionTestScopedClientChildV2(val) })
	transferRef(valPtr)
	ret := rawPtr.CallSetChildOwnPtrClientAndReturnParentV2(valPtr)
	runtime.KeepAlive(val)
	return wrapApiVersionTestScopedClient(unsafe.Pointer(ret))
}
...
func (obj *apiVersionTestImpl) SetChildRawPtrClientV2(val ApiVersionTestScopedClientChildV2) int32 {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetChildRawPtrClientV2 == 0 {
		return 0
	}
	valPtr := extractOrWrapRawPointer(val, func() any { return NewApiVersionTestScopedClientChildV2(val) })
	transferRef(valPtr)
	ret := rawPtr.CallSetChildRawPtrClientV2(valPtr)
	runtime.KeepAlive(val)
	return int32(ret)
}
