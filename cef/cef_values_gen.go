...
func (obj *valueImpl) IsEqual(that Value) bool {
	...
	thatPtr := extractRawPointer(that)
	transferRef(thatPtr)
	ret := rawPtr.CallIsEqual(thatPtr)
	runtime.KeepAlive(that)
	return ret != 0
}
...
func (obj *valueImpl) SetBinary(value BinaryValue) int32 {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetBinary == 0 {
		return 0
	}
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetBinary(valuePtr)
...
func (obj *valueImpl) SetDictionary(value DictionaryValue) int32 {
	...
	rawPtr := obj.rawPtr
	if rawPtr.SetDictionary == 0 {
		return 0
	}
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetDictionary(valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *valueImpl) SetList(value ListValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetList(valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *dictionaryValueImpl) SetValue(key string, value Value) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetValue(unsafe.Pointer(&keyStr), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *dictionaryValueImpl) SetBinary(key string, value BinaryValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetBinary(unsafe.Pointer(&keyStr), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *dictionaryValueImpl) SetDictionary(key string, value DictionaryValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetDictionary(unsafe.Pointer(&keyStr), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *dictionaryValueImpl) SetList(key string, value ListValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetList(unsafe.Pointer(&keyStr), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *listValueImpl) SetValue(index int, value Value) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetValue(uintptr(index), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *listValueImpl) SetBinary(index int, value BinaryValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetBinary(uintptr(index), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *listValueImpl) SetDictionary(index int, value DictionaryValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetDictionary(uintptr(index), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
...
func (obj *listValueImpl) SetList(index int, value ListValue) int32 {
	...
	valuePtr := extractRawPointer(value)
	transferRef(valuePtr)
	ret := rawPtr.CallSetList(uintptr(index), valuePtr)
	runtime.KeepAlive(value)
	return int32(ret)
}
